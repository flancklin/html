...
function(e, n, o) {
	...
	a = {},
	s = {
		getItem: "/API/Product/getProduct"
	},
	l = function(n, o, i,url) {
        if(!url ) url ="/API/Product/getProduct";
		e.ajax({
			url: url + "?v=" + Math.round(100 * Math.random()),
			type: "POST",
			dataType: "json",
			data: i,
			beforeSend: function() {
			...
			success: function(s) {
				if (1 == s.status) {
                    ...
                    if(i.type == "team_buy"){
                        _.each(c, function (i) {
                            i.thumb = i.cover_thumb,
							i.productName =  i.title,
							i.sellPrice = i.money
                        });
					...
					r = e(l);
					n && n.find(".jbox-container").empty().html(r)
				} else HYD.hint("danger", "获取数据失败，" + s.msg),
				n && e.jBox.close(n);
				e.jBox.hideloading()
			}
		})
	...
	r = function(e) {
		...
		if (n.length) {
			var o = n.split("/"),
			i = o[o.length - 1].replace(/.html/, "");
			return i
		}
	};
	e.selectGoods = function(n,param,url) {
        if(!param) param = {P:1};
		var o = e.extend(!0, {},
		i, n);
		c = null,
		...
		e.jBox.show({
			...
			onOpen: function(n) {
				l(n, o, param, url);
				var i = function() {
					var o = n.find(".paginate a.cur").text(),
					i = [],
					t = [];
				...
				n.on("click", ".paginate a",
				function() {
					if (!e(this).hasClass("cur")) {
						i();
						if($.inArray(param.type, ['mall', 'team_buy', 'group'])){
                            var t = r(e(this));
							param.p = t;
                            return l(n, o, param,url),!1
						}else{
                            var t = r(e(this)),
                                c = n.find("input[name=title]").val(),
                                a = n.find("select[name=status]").val(),
				...
				function() {
					...
					//i = n.find("select[name=status]").val(),
				...
				1 == o.selectMod ? n.on("click", ".j-select",
				function() {
					var i = e(this).data("index");
					o.callback && o.callback(c[i]),
					e.jBox.close(n)
				}) : (n.on("click", ".j-select",
				function() {
					var n = e(this),
					o = n.siblings(".j-chkbox");
				...
				function() {
					...
					var t = [],
					c = [];
					for (var s in a) t = t.concat(a[s].ids),
					c = c.concat(a[s].data);
					o.callback && o.callback(c, t),
					e.jBox.close(n)
				}), n.on("click", ".j-selectAll",
				function() {
					n.find(".j-select").addClass("cur"),
					n.find(".j-chkbox").attr("checked", !0)
				}), n.on("click", ".j-selectReverse",
				function() {
				...
				}), n.on("click", ".j-cancelSelectAll",
				function() {
					n.find(".j-select").removeClass("cur"),
					n.find(".j-chkbox").attr("checked", !1)
				}))
			},
			btnOK: {
				show: !1
    ...
    e.selectGoods2 = function(n,param,url) {
        if(!param) param = {P:1};
...
$(function() {
	...
	$.composeBox = function(t) {
		...
		function() {
			...
			n = c.content,
			o = html_encode(c.content),
			c.callback && c.callback(n, o),
			p(),
			e.destroy()
		}),
		s.on("click", ".J-noClk",
		...
		s.on("click", ".compose_lists li",
		function() {
			var n = $(this).find(".pEditor").html() + "<p></p>";
			e.focus(),
			e.execCommand("inserthtml", n)
		}),
	...
	renderData = function(e, n) {
		$.ajax({
			...
			success: function(n) {
				if (1 == n.status) {
					var o = $("#tpl_Compose_lists").html(),
					i = _.template(o, {
						dataset: n.data
					}),
					t = $(i);
					$("#tmpl .compose_lists").empty().append(t)
				} else HYD.hint("danger", "获取数据失败，"),
				$.jBox.close(e);
				$.jBox.hideloading()
			}
		})
...
HYD.FormShowError = function(e, n, o) {
	e && n && (void 0 == o && (o = !0), e.addClass("error").siblings(".fi-help-text").addClass("error").text(n).show(), o && e.focus(), "select" == e[0].nodeName.toLowerCase() && e.siblings(".select-sim").addClass("error"), e.one("change",
	function() {
...
HYD.ajaxPopTable = function(e) {
	...
	a = function(e) {
		...
		l = function(s) {
			...
			e && e(),
			t.onPageChange && t.onPageChange(o, n)
		};
		$.ajax({
	...
	a(function() {
		$.jBox.show({
			...
			onOpen: function(e) {
				o = e,
				t.onOpen && t.onOpen(e, n)
			}
		})
	})
},
HYD.popbox.ImgPicker = function(e) {
	var n, o = $("#tpl_popbox_ImgPicker").html(),
	i = $(o),
	t = function(e, o) {
		var c = function(e) {
	...
	c = function(n) {
		...
		i.find("#imgpicker_upload_input").uploadify({
			...
			onUploadSuccess: function(e, n, t) {
				...
				a = i.find(".imgpicker-upload-preview"),
				s = n.file_path;
				o.push(s);
				var l = _.template(c, {
					url: s
...
HYD.popbox.IconPicker = function(e) {
	var n, o = $("#icon_imgPicker").html(),
	i = $(o);
	n = $.browser.chrome ? "body": document.documentElement || document.body,
	$(n).append(i);
	...
	a = function(e) {
		...
		i.find(".albums-icon-tab").html(n),
		i.find(".albums-icon-tab").find("li").click(function(e) {
			var n = $(this);
			n.hasClass("selected") || n.addClass("selected").siblings("li").removeClass("selected")
		})
	};
	a(c),
	i.find(".albums-cr-actions").children("a").click(function(e) {
		var n = $(this),
		o = n.data("style");
		c.style = o,
	...
	i.find(".albums-color-tab").find("li").click(function(e) {
		...
		o = n.data("color");
		c.color = o,
		n.addClass("cur").siblings("li").removeClass("cur"),
		a(c),
...
HYD.popbox.ModulePicker = function(e) {
	var n, o = $("#tpl_popbox_ModulePicker").html(),
	i = $(o),
	t = function(e, o) {
		var c = function(e) {
			if (n = e.list, n && n.length) {
...
HYD.popbox.GoodsAndGroupPicker = function(e, n) {
	var o, i, t = $("#tpl_popbox_GoodsAndGroupPicker").html(),
	c = $(t),
	a = [],
	s = [],
	l = function(e, n) {
		var i = function(e) {
			if (o = e.list, o && o.length) {
				...
				r.find(".j-select").click(function() {
					...
					n.addClass("btn-success").text("已选"),
					a.push(o[t]),
					s.push(c),
					e.push(c),
					l = e.join(","),
...
HYD.popbox.MgzAndMgzCate = function(e, n) {
	var o, i, t = $("#tpl_popbox_MgzAndMgzCate").html(),
	c = $(t),
	a = function(e, n) {
		var i = function(e) {
			if (o = e.list, o && o.length) {
...
HYD.popbox.GamePicker = function(e, n) {
	...
	c = function(e, n, o) {
		var a = function(n) {
			if (t[e] = n.list, t[e] && t[e].length) {
				var a = $("#tpl_popbox_GamePicker_item").html(),
				s = _.template(a, {
					dataset: t[e]
				}),
				l = $(s);
	...
	a = function(e, o) {
		i.on("click", ".game-list-panel" + o + " .j-select",
		function() {
...
HYD.popbox.dplPickerColletion = function(e) {
	...
	o = $.extend(!0, {},
	n, e);console.log(JSON.stringify(o))
	...
	case 6:
		var i = {
			title: "店铺主页",
			link: Config.domain+'/VCrowd/Crowd/store'
		};
		o.callback(i, 6);
		break;
	case 7:
		var i = {
			title: "会员主页",
			link: Config.domain+'/VCrowd/Crowd/index'
		};
		o.callback(i, 7);
		break;
	case 8:
	...
	case 9:
		var i = {
			title: "购物车",
			link: Config.domain+'/VCrowd/Crowd/orderD'
		};
		o.callback(i, 9);
		break;
	case 10:
	...
	case 12:
		var i = {
			title: "商品分类",
			link: Config.domain+'/VCrowd/Crowd/classify'
		};
		o.callback(i, 12);
		break;
	case 13:
		var i = {
			title: "我的订单",
			link: Config.domain+'/VCrowd/Crowd/order'
		};
		o.callback(i, 13)
	}
},
...
HYD.urgencyPopup = function() {
	var e = $.cookie("urgencyPopup"),
	n = (new Date).getTime(),
	o = 36e5;
	if (e || (e = 0), console.log(e, o, n), 0 == e || parseInt(e) + o < n) {
		$.cookie("urgencyPopup", n, {
			expires: 30,
			path: "/"
		});
		var i = function(e) {
		...
		$("#urgency-content").jBox({
			title: "紧急通知",
			onOpen: function(e) {
				e.addClass("jbox-urgencyPopup"),
				$chk = e.find(".j-urgency-checkbox"),
				$btn = e.find(".j-urgency-submit"),
				$btn.click(function() {
					$chk.is(":checked") ? $.ajax({
						...
						success: function(n) {
							$.jBox.hideloading(),
							1 == n.status ? ($.jBox.close(e), HYD.hint("success", "恭喜您，临时域名申请成功！")) : HYD.hint("danger", "对不起，" + n.msg)
						}
					}) : i("请先注册域名并提交备案信息!")
				})
			},
...
$(function() {
	...
	$(".paginate").each(function() {
		...
		n.keypress(function(e) {
			...
			return 13 == n && (window.location.href = $(this).siblings("a.goto").attr("href")),
			8 == n || 46 == n || 37 == n || 39 == n || !(n < 48 || n > 57)
		}),
		n.keyup(function(e) {
			var n = $(this).val(),
			t = i.split("/"),
			...
			a = !1,
			s = !1;
			"" == t[c - 1] && (t.pop(), c = t.length, a = !0),
			(a || "p" != t[c - 2]) && (t.push("p"), c = t.length, s = !0),
			a || s ? t[c] = n + ".html": t[c - 1] = n + ".html",
			o.attr("href", t.join("/"))
		})
	})
}),
...
function(e, n, o) {
	...
	l = {
		getFolderTree: "/Manage/Design/getFolderTree",
		getSubFolderTree: "/Manage/Design/getSubFolderTree",
		getImgList: "/Manage/Design/getImgList",
		addImg: "/Manage/Design/uploadFile/sid/" + (e.cookie("supplierStoreId")>0?e.cookie("supplierStoreId"):e.cookie("storeId")),
		moveImg: "/Manage/Design/moveImg",
		delImg: "/Manage/Design/delImg",
		addFolder: "/Manage/Design/addFolder",
		renameFolder: "/Manage/Design/renameFolder",
		delFolder: "/Manage/Design/delFolder",
		moveCateImg: "/Manage/Design/moveCateImg",
		renameImg: "/Manage/Design/renameImg"
	},
	r = function(n, o, i, t) {
		...
		e.ajax({
			...
			success: function(o) {
				if (1 == o.status) {
					...
					{
						id: "0",
						picNum: o.data.nocat_total
					});
					var c = function(e) {
						var n = arguments.callee;
						_.each(e,
						function(e) {
							t.find("dt[data-id=" + e.id + "]").find(".j-num").text(e.picNum),
							e.subFolder && e.subFolder.length && n(e.subFolder)
						})
					};
					c(i)
	...
	e.albums = function(o) {
		...
		if (!d.length) {
				...
				e.ajax({
					...
					success: function(o) {
						if (1 == o.status) {
							...
							$render = e(t),
							n.parent("dt").siblings("dd").empty().append($render),
			...
			e(n).on("click", ".j-albumsNodes dt i", function() {
				...
				return n.hasClass("open") ? (n.removeClass("open"), o.slideUp(200)) : (n.addClass("open"), i ? o.slideDown(200) : j(n, t)),
				!1
			});
			var x = 0;
			...
			d.on("click", "#j-useImg", function() {
				...
				return t.callback && (t.callback(o), P()),
				!1
			});
			p.click(function() {
				var n = [{
			...
			m.click(function() {
				...
				i.blur(function() {
					...
					e.ajax({
						...
						success: function(e) {
							1 == e.status ? o.find(".j-name").text(n) : HYD.hint("danger", "对不起，重命名失败：" + e.msg),
							o.show(),
							i.hide(),
							t.hide()
						}
			...
			v.click(function() {
				...
				o || i || t || c || a || u || g || p ? (e("#j-addImg").parent("#addImg_load").addClass("btn btn-success").children(".addImg_load_text").text("上传图片"), e("#j-addImg").change(function() {
					...
					c = new FormData;
					t.open("POST", l.addImg, !0),
					e.jBox.showloading("正在上传..."),
					t.onreadystatechange = function() {
						if (4 == t.readyState && 200 == t.status) {
							var n = e.parseJSON(t.responseText);
							1 == n.status ? (r(d, s.folderID, 1), UpdateSubTreeNums()) : HYD.hint(n.msg),
							e.jBox.hideloading()
						}
					},
					c.append("Filedata", o),
			...
			b.click(function() {
				...
				n.append($.find("dd:first").contents().clone()),
				e.jBox.show({
					title: "请选择移动文件夹",
					content: n,
					onOpen: function() {
							...
							e.ajax({
								...
								success: function(o) {
									if (1 == o.status) {
										...
										d.find("#j-panelImgs li.selected").fadeOut(300,
										function() {
											e(this).remove()
										}),
										UpdateSubTreeNums(),
		...
		d.outerHeight() >= c.height && d.css({
			position: "absolute",
			marginTop: "0",
			top: e(n).scrollTop() + 10
		}),
		d.on("click", ".renameImg",
		function() {
			var n = e(this),
...
$(function() {
	...
	$(".j-vir-chkb").each(function() {
		...
		a = !!c.is(":checked");
		a ? (n.removeClass("disable").addClass("enable"), i.show(), t.hide()) : (n.removeClass("enable").addClass("disable"), i.hide(), t.show()),
		c.change(function() {
			var e, n = $(this),
			i = n.attr("name"),
			t = {};
			e = "undefined" == typeof n.data("enableval") ? n.is(":checked") ? 1 : 0 : n.is(":checked") ? n.data("enableval") : n.data("disableval"),
			t.name = i,
			t.value = e;
		...
		n.show().click(function() {
			...
			function() {
				i.hide()
			}), c.attr("checked", !1), a = !1) : (i.show(), n.animate({
				left: 0
			},
			150,
			function() {
				t.hide()
			}), c.attr("checked", !0), a = !0),
			c.trigger("change")
		})
	}),
	...
	$(".j-text-autosave-judge").change(function() {
		...
		c = i.attr("name"),
		a = i.val(),
		s = (i.attr("placeholder"), $(e)),
		l = i.get(0).nextSibling,
		r = l ? $(l) : i;
		a ? t.test(a) ? $.ajax({
			url: o + "?v=" + Math.round(100 * Math.random()),
			type: "POST",
	...
	$(".j-text-autosave-judge2").change(function() {
		...
		})) : (HYD.hint("danger", "只能设置正整数（默认为0）!", 1200), i = !1, !1)
	})
}),
$(function() {
	...
	if (0 == n) $(".fixedBar").hide();
		...
		$(window).scroll(function(e) {
			for (var n = $(window).scrollTop(), o = 0; o < i.array_height.length; o++) {
				...
				if (0 == o) n < t && $(".shopManager" + i.array_id[o]).addClass("cur").siblings("li").removeClass("cur");
				else {
	...
	$(".fixedBar>ul>li>a").click(function(e) {
		...
		o = n.data("target"),
		i = $(o).offset().top;
		$.browser.chrome ? elem = "body": elem = document.documentElement || document.body,
		$(elem).animate({
			scrollTop: i
		},
		600)
